...
public class BukkitVersionHelperSpigot121_11 extends BukkitVersionHelper {
	...
	public void initializeBlockStates() {
		...
		while (iter.hasNext()) {
			...
			if (bd.a(TagsBlock.av)) { bld.setLog(); } // BlockBehaviour$BlockStateBase.is(OVERWORLD_NATURAL_LOGS)
			if (bd.a(TagsBlock.M)) { bld.setLeaves(); } // BlockBehaviour$BlockStateBase.is(LEAVES)
	...
	public String getBiomeBaseIDString(Object bb) {
		return Objects.requireNonNull(getBiomeReg().b((BiomeBase)bb)).a(); // MinecraftKey.getPath()
	}
	@Override
	public String getBiomeBaseResourceLocsation(Object bb) {
		return Objects.requireNonNull(getBiomeReg().b((BiomeBase)bb)).toString();
	}
	...
	public Object readTileEntityNBT(Object te, org.bukkit.World w) {
		...
		return tileent.d(cw.getHandle().J_()); // TileEntity.saveCustomOnly ; LevelReader.registryAccess
	}
